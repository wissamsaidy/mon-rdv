...
insert into "praticien" ("carte_vitale", "cb", "cheque", "code_postal", "convention", "duree_creneau", "email", "espece", "id", "matricule", "mot_de_passe", "nom", "photo", "prenom", "rue", "telephone", "version", "ville") values (false, false, false, NULL, NULL, 0, 'thierry.lab@gmail.com', false, '0', NULL, NULL, 'duduche2', NULL, 'Thierry', NULL, NULL, 0, NULL);
insert into "praticien" ("carte_vitale", "cb", "cheque", "code_postal", "convention", "duree_creneau", "email", "espece", "id", "matricule", "mot_de_passe", "nom", "photo", "prenom", "rue", "telephone", "version", "ville") values (true, true, true, NULL, NULL, 2, NULL, true, '3', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL);
...
insert into "patient" ("code_postal", "date_naissance", "email", "id", "mot_de_passe", "nom", "numeross", "prenom", "rue", "telephone", "version", "ville") values ('78600', '1990-03-02', 'prisc.daoul@gmail.com', '0', 'password', 'Daoulas', NULL, 'Priscille', 'rue parigot', NULL, 0, 'Verse-aïe');
